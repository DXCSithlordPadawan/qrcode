    ...
    def process_qr_code(self, qr_data):
        ...
        try:
            ...
            if qr_data in locations:
                ...
                description = location_info.get('description', qr_data) if isinstance(location_info, dict) else str(location_info)
                
                print(f"✓ LOCATION SET: {qr_data} - {description}")
                self.logger.info(f"Location updated to: {qr_data} - {description}")
            ...
            if qr_data in objects:
                ...
                if self.current_location:
                    ...
                    print(f"✓ OBJECT SCANNED: {qr_data} at location {self.current_location}")
                    ...
                    print(f"⚠ OBJECT DETECTED: {qr_data} but NO LOCATION SET")
